# CMD_RM CMD_MKDIR CMD_CP LIBCACHEDIR PLATFORM CONFIG FLAGS DLLS
CORE_MAJ=1
CORE_MIN=0
LIBS=
...
#	gcc -Ilibraries $(LIBFLAGS) $(PLATFORMFLAGS) $(FLAGS) -x c++ -c $< -o $@
...
o/core.o: libraries/core.cpp $(CORE_HDRS) | o
	gcc -Ilibraries $(LIBFLAGS) $(PLATFORMFLAGS) $(FLAGS) $(DEPENDENCIESFLAGS) -DLIB_MAJ=$(CORE_MAJ) -DLIB_MIN=$(CORE_MIN) -x c++ -c $< -o $@
